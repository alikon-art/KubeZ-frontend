<template>
    ...
    <configmapCreateForm></configmapCreateForm>
  ...
  // import "codemirror/mode/javascript/javascript.js"
    ...
    // 导入表单组件
    import configmapCreateForm from './configmapCreateForm.vue'
    ...
    postStore.postData.item = configmapStore.configmap
    ...
    const create = () => {
      postStore.postUrl = 'configmap/add'
